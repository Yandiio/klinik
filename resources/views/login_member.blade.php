			...
			<div role="main" class="main">
				...
				<div class="slider-with-overlay">
					...
					<div class="slider-container rev_slider_wrapper" style="height: 100px;">
						<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.7" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 660, 'responsiveLevels': [4096,1200,992,500]}">

							<img src="{{ asset('assets/img/dark-cover.jpg') }}"
								alt=""
								style="width:1700; height:800px;"
												...
												<form id="frmLogin" action="#" method="POST">
													<div class="form-row">
														...
														<div class="form-group col-lg-12">
															...
															<input type="password" maxlength="100" class="form-control" name="password" id="password" placeholder="Password" required>
														</div>
													</div>
													<br>
													<div class="form-row">
														<div class="form-group">
															<input type="submit" value="Login!" class="btn btn-primary mb-5" id="btnLogin" data-loading-text="Loading...">
