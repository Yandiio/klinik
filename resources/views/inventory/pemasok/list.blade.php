...
<section role="main" class="content-body">
				...
				<div class="col">
					<section class="card">
						<header class="card-header">
							...
							<h2 class="card-title">List Pemasok</h2>
						</header>
						<div class="card-body">
									...
									<thead>
										...
										<tbody>
											<tr>
												<td >1</td>
												<td>KP-001</td>
												<td>Supplier panadol</td>
												{{-- <td>Jalan Cakung TImur</td> --}}
												{{-- <td>cahyadihelmay@gmail.com</td> --}}
												<td>089525863219</td>
        ...
        <div id="modalMD" class="modal-block modal-header-color modal-block-success mfp-hide">
			<section class="card">
				<header class="card-header">
					<h2 class="card-title">Tambah Pemasok</h2>
				</header>
				<div class="card-body">
