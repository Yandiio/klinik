    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="button" href="#modalMD" class="btn btn-success modal-sizes " style="margin-bottom: 20px"
                            title="Tambah Tipe Pendaftaran !">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn-sm btn-warning modal-sizes" title="Ubah Data !"
                                                style="margin-right:5px" href="#modalMDEdit"><i class="fa fa-edit"
                                                    aria-hidden="true"></i></button>
                                            <button type="button" href="" class="btn-sm btn-danger" title="Hapus Data !"
                                                style="margin-right:5px"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td>
                                            <button type="button" href="" class="btn-sm btn-warning" title="Ubah Data !"
                                                style="margin-right:5px"><i class="fa fa-edit" aria-hidden="true"></i></button>
                                            <button type="button" href="" class="btn-sm btn-danger" title="Hapus Data !"
                                                style="margin-right:5px"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                ...
                <div class="card-body">
                    <div class="modal-wrapper">
                        <div class="modal-text">
                            ...
                            <label class="control-label">Supliyer <span class="required">*</span></label>
                            <select class="form-control form-control-sm mb-2" name="" id="">
                                <option value="">Supliyer 1</option>
                                <option value="">Supliyer 2</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-text">
