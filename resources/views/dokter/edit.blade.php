                                        ...
                                        <div id="w2-account" class="tab-pane p-3 active">
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-username">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm mb-3" id="w2-username" value="KD-001" name="" placeholder="Kode Dokter"  >
                                                    </div>
                                                <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-username">
                                        ...
                                        <div id="w2-profile" class="tab-pane p-3">
                                            <div class="form-group row">
                                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-first-name">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="item">
                                                                <img src="{{asset('assets/img/logo.png')}}" alt="" class="rounded-circle" style="width:40%">
                                                            </div>
                                                        </div> 
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" data-plugin-datepicker class="form-control form-control-sm mb-3" value="01/01/1990" placeholder="01/01/2019">
                                                            </div>
                                                        </div>
                                                </div>   
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm mb-3" value="Dr.Agus Setyadi" name="last-name" id="w2-last-name" placeholder="Nama Lengkap">
                                                        </div>
                                                        <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                            Tempat Lahir <span class="required">*</span>
                                                        </label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm mb-3" value="Jakarta" name="last-name" id="w2-last-name" placeholder="Tempat Lahir">
                                                        </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="email" class="form-control form-control-sm mb-3" value="agus@gmail.com" name="last-name" id="w2-last-name" placeholder="Email">
                                                        </div>
                                                        <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                            No. Telepon <span class="required">*</span>
                                                        </label>
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control form-control-sm mb-3" value="123456789" name="last-name" id="w2-last-name" placeholder="No Telepon">
                                                            </div>
                                                </div>
                                        </div>
