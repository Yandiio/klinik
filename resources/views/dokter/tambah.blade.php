                                    ...
                                    <div class="tab-content">
                                        <div id="w2-account" class="tab-pane p-3 active">
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-username">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm mb-3" id="w2-username" name="" placeholder="Kode Dokter"  >
                                                    </div>
                                                <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-username">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm mb-3" name="last-name" id="w2-last-name" placeholder="Nama Lengkap">
                                                        </div>
                                                        <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                            Tempat Lahir <span class="required">*</span>
                                                        </label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control form-control-sm mb-3" name="last-name" id="w2-last-name" placeholder="Tempat Lahir">
                                                        </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="email" class="form-control form-control-sm mb-3" name="last-name" id="w2-last-name" placeholder="Email">
                                                        </div>
                                                        <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">
                                                            No. Telepon <span class="required">*</span>
                                                        </label>
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control form-control-sm mb-3" name="last-name" id="w2-last-name" placeholder="No Telepon">
                                                            </div>
                                                </div>
                                        </div>
                                        <div id="w2-confirm" class="tab-pane p-3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm mb-3" name="last-name" id="w2-last-name" placeholder="Kode Pos">
                                                </div>
