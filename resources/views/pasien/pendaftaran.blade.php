                        ...
                        <div class="tab-content">
                            <div id="w2-account" class="tab-pane p-3 active">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">Kabupaten
                                        <span class="required">*</span></label>
                                    <div class="col-sm-4">
                                        <select name="" id="" class="form-control form-control-sm mb-3">
                            ...
                            <div id="w2-profile" class="tab-pane p-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-last-name">No
                                        Polis <span class="required">*</span></label>
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control form-control-sm mb-3" name="first-name"
                                            id="w2-first-name">
                                    </div>
                            ...
                            <div id="w2-confirm" class="tab-pane p-3">
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-username">Golongan
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="w2-password">Tipe
                                        Poli<span class="required">*</span></label>
                                    <div class="col-sm-4">
                                    ...
                                    <label class="col-sm-2 control-label text-sm-right pt-1" for="textareaAutosize">Keluhan
                                        <span class="required">*</span></label>
                                    <div class="col-lg-4">
                                        <textarea class="form-control" rows="3" id="textareaAutosize"
                                            data-plugin-textarea-autosize></textarea>
