    ...
    <div class="row">
        ...
        <div class="card">
                <div class="card-header">
                        ...
                        style="padding-button:200px" title="Tambah Tipe Pendaftaran !">
                        Tambah
                ...
                <div class="col-md-12">
                <table id="tableTipeAsuransi" class="table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Asuransi</th>
            ...
            <div class="card-body">
                <div class="modal-wrapper">
                    <div class="modal-text">
                        ...
                        <input type="text" name="fullname" class="form-control" placeholder="Tipe Pendaftaran"
                            required />
