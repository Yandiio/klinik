                    ...
                    <section class="card card-group">
                        <header class="card-header bg-primary">
                            ...
                            <div class="widget-profile-info">
                                ...
                                <img src="{{ asset('assets/img/!logged-user.jpg') }}">
                                </div>
                            ...
                            <ol class="tm-items">
                                ...
                                <li>
                                    <div class="tm-box">
                                        ...
                                        <a class="img-thumbnail lightbox" href="{{ asset('assets/img/projects/project-4.jpg') }}" data-plugin-options='{ "type":"image" }'>
                                        <img class="img-fluid" width="215" src="{{ asset('assets/img/projects/project-4.jpg') }}">
                                                <span class="zoom">
