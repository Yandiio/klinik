					...
					<div class="modal-wrapper">
                        ...
                        <div class="modal-text">
                            <label class="control-label">No Telepon Asuransi<span class="required">*</span></label>
                                <input type="text" name="fullname" class="form-control" placeholder="No Telp Asuransi" required/>
                        </div>
                        <div class="modal-text">
					...
					<div class="modal-wrapper">
                            <div class="card-body">
                                <div class="modal-wrapper">
                                    ...
                                    <div class="modal-text">
                                        <label class="control-label">No Telepon Asuransi<span class="required">*</span></label>
                                            <input type="text" value="0234234324234" name="fullname" class="form-control" placeholder="No Telepon Asuransi" required/>
                                    </div>
                                    <div class="modal-text">
                                        <label class="control-label">Alamat<span class="required">*</span></label>
