...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Report Poli Lab</span></li>
            </ol>
    ...
    <!-- start: page -->
        <h4 class="mt-0 mb-0">Info report poli lab dalam bentuk grafik</h4>
            ...
            <div class="col-lg-12">
                <section class="card">
                    <header class="card-header">
                        ...
                        <h2 class="card-title">Filter data laporan poli lab</h2>
                    </header>
                    <div class="card-body">
                        <form class="form-horizontal form-bordered">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <button type="submit" class="col-lg-3 btn btn-success text-lg-left"><i class="fa fa-file"></i> Excel</button>
                            </div>
                        </form>
                        <div id="salesSelectorItems" class="chart-data-selector-items mt-3">
                                <p>Grafik Data Poli Lab Senin, 02 Februari 2019 s/d Sabtu, 24 Februari 2019</p>
