...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Report Poli Gigi</span></li>
            </ol>
    ...
    <!-- start: page -->
        <h4 class="mt-0 mb-0">Info report poli gigi dalam bentuk grafik</h4>
            ...
            <div class="col-lg-12">
                <section class="card">
                    <header class="card-header">
                        ...
                        <h2 class="card-title">Filter data laporan poli gigi</h2>
                    </header>
                    <div class="card-body">
                        ...
                        <div id="salesSelectorItems" class="chart-data-selector-items mt-3">
                                <p>Grafik Data Poli Gigi Senin, 02 Februari 2019 s/d Sabtu, 24 Februari 2019</p>
