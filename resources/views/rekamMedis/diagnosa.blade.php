                        ...
                        <div class="modal-body">
                            <div class="modal-wrapper">
                                <div class="modal-text">
                                    ...
                                    <input type="text" name="NewKode" class="form-control" placeholder="Kode Diagnosa"
                                        value="001" required disabled />
                                </div>
                                <div class="modal-text">
                                    <label class="control-label">Nama Pasien</label>
                                    <input type="text" name="NewNama" class="form-control" placeholder="Nama Diagnosa"
                                        value="Rudi" disabled required />
                                </div>
                                <div class="modal-text">
                                    <label class="control-label">Umur </label>
                                    <input type="text" name="NewHasil" class="form-control" placeholder="Hasil diagnosa"
                                        value="" disabled required />
                                </div>
                                <div class="modal-text">
                                    <label class="control-label">Keluhan </label>
                                    <textarea class="form-control" name="NewKeterangan" rows="3" id="textareaAutosize"
                                        value="Rudi" disabled data-plugin-textarea-autosize></textarea>
                                </div>
                                <div class="modal-text">
                                ...
                                <div class="modal-text">
                                    <label class="control-label">Hasil diagnosa <button type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-default" id="add">Tambah</button></label>
                                    <div id="items">
                        ...
                        <div class="modal-body">
                            <div class="modal-wrapper">
                                ...
                                <div class="modal-text">
                                    ...
                                    <select name="" class="form-control form-control-lg mb-3" id="">
                                        <option value="">tess</option>
                                    </select>
                                </div>
                            </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        // console.log(type);
                        let buttonEdit =
                            '<button type="click" class="btn-sm btn-warning"  title="Ubah Data !" style="margin-right:5px" data-toggle="modal" data-target="#modalUbah" onclick="buttonEdit(' +
